...
class MainMenuState extends MusicBeatState
{
	...
	if (StoryMenuState.weekUnlocked[2])
		{ 
		['story mode', 'freeplay', 'cutscenes', 'options'];
		}
		else
			{
	...
	override function create()
	{
		...
		{
			var menuItem:FlxSprite = new FlxSprite(10, 50 + (i * 165));
			menuItem.frames = tex;
		...
		{var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, "v" + "0.2.7.1 - FNF / Spring Engine 1.0", 12);
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.mouse.justPressed && FlxG.mouse.overlaps(videos))
			{			}
