...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		new OptionCategory("Gameplay", [
			...
			new HealthBarColours("Show every character with a different colour"),
			new DownScroll("Notes Scroll Down"),
			new MidScroll("Notes Scroll to Middle"),
			new SongPositionOption("Makes a bar of Song Progress"),
		]),
		new OptionCategory("Performance", [
			new Antialiasing("Set Antialiasing to sprites (deactivating this option makes your game faster)"),
			new Optimization("MAX OPTIMIZE!")
		]),
		new OptionCategory("HUD", [
			new EngineWatermarks("See Engine Watermarks InGame"),
			new Language("Only Changes Video Language")
		]),
		new OptionCategory("RESET", [
			new ResetSettings("Reset Options to default value"),
		])
	];
