...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'ara':
				tex = Paths.getSparrowAtlas('characters/Ara');
				frames = tex;

				animation.addByPrefix('idle', "Ara Idle", 24, false);
				animation.addByPrefix('singUP', "Ara Up", 24, false);
				animation.addByPrefix('singDOWN', "Ara Down", 24, false);
				animation.addByPrefix('singLEFT', 'Ara Left', 24, false);
				animation.addByPrefix('singRIGHT', 'Ara Right', 24, false);

				animation.addByPrefix('nya', 'Nya', 15, false);

				addOffset('idle', 0, 0);
				addOffset('singUP', 31, 34);
				addOffset('singDOWN', 7, -58);
				addOffset('singLEFT', 13, -1);
				addOffset('singRIGHT', 0, -41);
			...
			case 'aranya':
				tex = Paths.getSparrowAtlas('characters/AraNya');
				frames = tex;
			...
			case 'araver':
				tex = Paths.getSparrowAtlas('characters/AraVer');
				frames = tex;
			...
			case 'monster':
				var tex = if(PlayState.SONG.song.toLowerCase() == 'monster')
				{Paths.getSparrowAtlas('characters/monsterStreetlight');}
				else
				{Paths.getSparrowAtlas('characters/Monster_Assets');}
				frames = tex;
			...
			case 'monster-streetlight':
				tex = Paths.getSparrowAtlas('characters/MonsterStreetLight');
				frames = tex;
			    animation.addByPrefix('idle', 'monster idle', 24, false);
				animation.addByPrefix('singUP', 'monster up note', 24, false);
				animation.addByPrefix('singDOWN', 'monster down', 24, false);
			...
			case 'bf':
				var tex = if(PlayState.SONG.song.toLowerCase() == 'monster')
				{Paths.getSparrowAtlas('characters/bfStreetlight');}
				else
			...
			case 'parents-christmas':
				...
				case 'bf-tabi-crazy':
				var tex = Paths.getSparrowAtlas('characters/BF_post_exp');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
			...
			case 'tabi-crazy':
				...
				addOffset('idle');
				addOffset("singUP", 59, 94);
				addOffset("singRIGHT", -15, -19);
				addOffset("singLEFT", 227, -5);
				addOffset("singDOWN", 2, -54);
